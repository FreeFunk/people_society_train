...
public class SocietyStudentPractiseQuestOptionService {
	...
	public List<SocietyStudentPractiseQuestOption> selectByStudyQuestionId(String studyQuestionId) {
		return societyStudentPractiseQuestOptionMapper.selectByStudyQuestionId(studyQuestionId);
	}
}
