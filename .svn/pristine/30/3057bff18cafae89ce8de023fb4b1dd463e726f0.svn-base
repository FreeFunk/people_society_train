...
public interface SocietySchoolCourseNodeQuestionMapper  extends BaseMapper<SocietySchoolCourseNodeQuestion>{
	...
	List<SocietySchoolCourseNodeQuestion> selectByAll();

	void updateList(@Param("questionList")List<SocietySchoolCourseNodeQuestion> questionList);

    List<SocietySchoolCourseNodeQuestionView> selectByNodeId(@Param("nodeId")String nodeId);

    String selectByNodeIdAndQuestionName(@Param("nodeId")String nodeId,@Param("questionName") String questionName);

    void updateByNodeIdList(@Param("list")List<SocietySchoolCourseNodeQuestionView> list);
}