...
public class SocietyStudentStudyProcessService {
	...
	@Transactional(propagation = Propagation.REQUIRED,rollbackFor=Exception.class)
	public void updateByListId2(List<SocietyStudentStudyProcessView> studyList) {
		societyStudentStudyProcessMapper.updateByListId2(studyList);
	}

	public List<SocietyStudentStudyProcessView> selectByNodeIdAndSchoolId(String oldNodeId, String schoolId) {
		return societyStudentStudyProcessMapper.selectByNodeIdAndSchoolId(oldNodeId,schoolId);
	}
}
