...
public class SocietySchoolCourseUseGloble implements Serializable{
	 ...
	 * 属性描述:公共课类型
	 */
	@TableField(value="GLOBLE_TYPE",exist=true)
	java.lang.String globleType;
	...
	public String getGlobleType() {
		return globleType;
	}

	public void setGlobleType(String globleType) {
		this.globleType = globleType;
	}
