...
public interface SocietyStudentStudyProcessFaceMapper  extends BaseMapper<SocietyStudentStudyProcessFace>{
    ...
    SocietyStudentStudyProcessFace selectByStuCouIdAndNodeIdOnce(@Param("ownerStudentAndCourseId")String ownerStudentAndCourseId,
																 @Param("nodeId")String nodeId);

    List<SocietyStudentStudyProcessFace> selectByOperId(String opeId);

	void updateList(@Param("list")List<SocietyStudentStudyProcessFace> list);
}