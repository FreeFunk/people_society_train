        ...
        if(flag){
            ...
            if(notCerStulist.size()!=0){//存在学员没有证书
                ...
                for (SocietyStudentAndCourse societyStudentAndCourse : notCerStulist){
                    ...
                    societyStudentCertificate.setProvinceId(societySchool.getProvinceId());
                    societyStudentCertificate.setProvinceName(societySchool.getProvinceName());
                    societyStudentCertificate.setCityId(societySchool.getCityId());
                    societyStudentCertificate.setCityName(societySchool.getCityName());
                    societyStudentCertificate.setXianquId(societySchool.getXianquId());
                    societyStudentCertificate.setXianquName(societySchool.getXianquName());
                    //3.进行插入
