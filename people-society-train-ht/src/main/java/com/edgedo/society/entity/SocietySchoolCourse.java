...
public class SocietySchoolCourse implements Serializable{
	 ...
	 * 属性描述:课程所属学校ID
	 */
	@TableField(value="OWNER_SCHOOL_COURSE_ID",exist=true)
	java.lang.String ownerSchoolCourseId;
	...
	public String getOwnerSchoolCourseId() {
		return ownerSchoolCourseId;
	}

	public void setOwnerSchoolCourseId(String ownerSchoolCourseId) {
		this.ownerSchoolCourseId = ownerSchoolCourseId;
	}
