...
public class SocietyStudentAndCourseService {
	...
	public int deleteByIds(List<String> ids) {
		...
		return societyStudentAndCourseMapper.updateBatchIds(ids);
	}
	...
	public SocietyStudentAndCourse selectByStuIdCardAndCourseId(String studentIdCardNum, String courseId) {
		return societyStudentAndCourseMapper.selectByStuIdCardAndCourseId(studentIdCardNum,courseId);
	}
}
