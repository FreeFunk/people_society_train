...
public interface SocietySchoolCourseUseGlobleMapper  extends BaseMapper<SocietySchoolCourseUseGloble>{
	...
	public List<SocietySchoolCourseUseGlobleView> listPageNew(SocietySchoolCourseUseGlobleQuery query);
    ...
    List<String> selectByCourseIdInSchoolId(String schoolId);
