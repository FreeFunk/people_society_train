...
public class PeopleSocietyTrainQtCodeGenIn {
	
	public static void main(String[] args) throws Exception {
		//TODO:表名
		String tableName = "society_school_config_key";
		//TODO:项目文件夹
		String projectDir = "people-society-train-qt";
		//TODO:mapper文件夹
		String mapperDir = "society";
		//TODO:模块包路径
		String modelpackage = "com.edgedo.society";
		//TODO:前端的包路径
		String packageName = "society.society_school_config_key";
		//TODO:访问url前缀
		...
		String path = PeopleSocietyTrainQtCodeGenIn.class.getProtectionDomain().getCodeSource().getLocation().getFile();
