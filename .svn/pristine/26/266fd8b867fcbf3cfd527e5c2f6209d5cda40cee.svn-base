...
@TableName("society_test_paper")
public class SocietyTestPaper implements Serializable{
	 ...
	 * 属性描述:判断题目数
	 */
	@TableField(value="PANDUAN_QUESTION_NUM",exist=true)
	java.lang.Integer panduanQuestionNum;
	
	/**
	 * 属性描述:判断每题分数
	 */
	@TableField(value="PANDUAN_SCORE",exist=true)
	java.math.BigDecimal panduanScore;
	
	/**
	 * 属性描述:单选题目数
	 */
	@TableField(value="DANXUAN_QUESTION_NUM",exist=true)
	java.lang.Integer danxuanQuestionNum;
	
	/**
	 * 属性描述:单选每题分数
	 */
	@TableField(value="DANXUAN_SCORE",exist=true)
	java.math.BigDecimal danxuanScore;
	...
	public Integer getTestPaperTimeLength() {
		return testPaperTimeLength;
	}

	public void setTestPaperTimeLength(Integer testPaperTimeLength) {
	...
	public java.lang.Integer getPanduanQuestionNum(){
		return this.panduanQuestionNum;
	}
	
	public void setPanduanQuestionNum(java.lang.Integer panduanQuestionNum){
		this.panduanQuestionNum=panduanQuestionNum;
	}
	
	
	public java.math.BigDecimal getPanduanScore(){
		return this.panduanScore;
	}
	
	public void setPanduanScore(java.math.BigDecimal panduanScore){
		this.panduanScore=panduanScore;
	}
	
	
	public java.lang.Integer getDanxuanQuestionNum(){
		return this.danxuanQuestionNum;
	}
	
	public void setDanxuanQuestionNum(java.lang.Integer danxuanQuestionNum){
		this.danxuanQuestionNum=danxuanQuestionNum;
	}
	
	
	public java.math.BigDecimal getDanxuanScore(){
		return this.danxuanScore;
	}
	
	public void setDanxuanScore(java.math.BigDecimal danxuanScore){
    ...
    public String toString() {
        ...
        sb.append("Hash = ").append(hashCode());
			...
			sb.append(", panduanQuestionNum=").append(panduanQuestionNum);			
			sb.append(", panduanScore=").append(panduanScore);			
			sb.append(", danxuanQuestionNum=").append(danxuanQuestionNum);			
			sb.append(", danxuanScore=").append(danxuanScore);			
        sb.append("]");
        return sb.toString();
    }
    ...
    public boolean equals(Object that) {
        ...
        SocietyTestPaper other = (SocietyTestPaper) that;
        boolean flag = true;
        return  flag
        		&&(this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))		
				        		...
				        		&&(this.getPanduanQuestionNum() == null ? other.getId() == null : this.getPanduanQuestionNum().equals(other.getPanduanQuestionNum()))		
				        		&&(this.getPanduanScore() == null ? other.getId() == null : this.getPanduanScore().equals(other.getPanduanScore()))		
				        		&&(this.getDanxuanQuestionNum() == null ? other.getId() == null : this.getDanxuanQuestionNum().equals(other.getDanxuanQuestionNum()))		
				        		&&(this.getDanxuanScore() == null ? other.getId() == null : this.getDanxuanScore().equals(other.getDanxuanScore()))		
				;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getId() == null) ? 0 : getId().hashCode());		
		        ...
		        result = prime * result + ((getPanduanQuestionNum() == null) ? 0 : getPanduanQuestionNum().hashCode());		
		        result = prime * result + ((getPanduanScore() == null) ? 0 : getPanduanScore().hashCode());		
		        result = prime * result + ((getDanxuanQuestionNum() == null) ? 0 : getDanxuanQuestionNum().hashCode());		
		        result = prime * result + ((getDanxuanScore() == null) ? 0 : getDanxuanScore().hashCode());		
		;
        return result;
    }
