...
//	查出学生关联的小节id
    ...
    Integer selectByStuCouIdCountStudyLength(String stuCourseId);

	SocietyStudentAndNode selectByLastStudyTime(String stuCourseId);

    int selectByCourseIdAndTime(@Param("nodeId")String nodeId,
								@Param("monthStartDay")String monthStartDay,
								@Param("monthEndDay")String monthEndDay);

	int selectByCourseIdAndTimeNew(@Param("nodeId")String nodeId);


	List<SocietyStudentAndNodeView> selectByNodeIdAndSchoolId(@Param("oldNodeId")String oldNodeId,
															  @Param("schoolId")String schoolId);

	void updateByList(@Param("stuNodeList")List<SocietyStudentAndNodeView> stuNodeList);
}