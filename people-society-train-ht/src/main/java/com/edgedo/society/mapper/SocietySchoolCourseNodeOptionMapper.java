...
public interface SocietySchoolCourseNodeOptionMapper  extends BaseMapper<SocietySchoolCourseNodeOption>{
	...
	List<SocietySchoolCourseNodeOptionView> selectOptionByQuestionNew(String questionId);
    ...
    List<String> selectRightByQuestion(String questionId);

    List<SocietySchoolCourseNodeOptionView> selectByAllByNull();

	void updateByList(@Param("optionList") List<SocietySchoolCourseNodeOptionView> optionList);
