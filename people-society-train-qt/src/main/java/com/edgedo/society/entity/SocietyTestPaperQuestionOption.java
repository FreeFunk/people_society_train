...
@TableName("society_test_paper_question_option")
public class SocietyTestPaperQuestionOption implements Serializable{
    ...
    public boolean equals(Object that) {
        ...
        SocietyTestPaperQuestionOption other = (SocietyTestPaperQuestionOption) that;
        boolean flag = true;
        return  flag
