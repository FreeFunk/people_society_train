...
public class SocietyStudentTestPaper implements Serializable{
	...
	java.lang.Integer optionRightNum;

	/**
	 * 属性描述:数据状态
	 */
	@TableField(value="JUDGE_RIGHT_NUM",exist=true)
	java.lang.Integer judgeRightNum;

	/**
	 * 属性描述:数据状态
	 */
	@TableField(value="TEST_RIGHT_RATE",exist=true)
	java.math.BigDecimal testRightRate;
	...
	public Integer getOptionRightNum() {
		return optionRightNum;
	}

	public void setOptionRightNum(Integer optionRightNum) {
		this.optionRightNum = optionRightNum;
	}

	public Integer getJudgeRightNum() {
		return judgeRightNum;
	}

	public void setJudgeRightNum(Integer judgeRightNum) {
