...
public class SocietySchoolCourseNodeQuestionView extends SocietySchoolCourseNodeQuestion {
    ...
    private String studentIsAnswer;

    //选项list
    private List<SocietySchoolCourseNodeOptionView> optionList;
    ...
    public String getStudentIsAnswer() {
        return studentIsAnswer;
    }

    public void setStudentIsAnswer(String studentIsAnswer) {
        this.studentIsAnswer = studentIsAnswer;
    }
