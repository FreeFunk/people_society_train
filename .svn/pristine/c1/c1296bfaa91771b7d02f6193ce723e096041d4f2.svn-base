...
public class SocietySchoolCourseNodeOptionService {
	...
	public List<SocietySchoolCourseNodeOptionView> selectOptionByQuestionNew(String questionId){
		return societySchoolCourseNodeOptionMapper.selectOptionByQuestionNew(questionId);
	}
	...
	public List<String> selectRightByQuestion(String questionId) {
		return societySchoolCourseNodeOptionMapper.selectRightByQuestion(questionId);
	}

	public List<SocietySchoolCourseNodeOptionView> selectByAllByNull() {
		return societySchoolCourseNodeOptionMapper.selectByAllByNull();
	}

	@Transactional(propagation = Propagation.REQUIRED,rollbackFor=Exception.class)
	public void updateByList(List<SocietySchoolCourseNodeOptionView> optionList) {
		societySchoolCourseNodeOptionMapper.updateByList(optionList);
	}
}
