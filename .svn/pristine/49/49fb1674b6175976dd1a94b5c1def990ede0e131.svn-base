...
public class SocietySchoolController extends BaseController{
	...
	@RequestMapping(value = "/listSchoolGlobleDtree",method = RequestMethod.POST)
	public ModelAndView listSchoolGlobleDtree(){
		ModelAndView modelAndView = new ModelAndView();
		User user = getLoginUser();
		String schoolId = user.getCompId();
		List<Dtree> dtreeList = service.listSchoolGlobleDtree(schoolId);
		return buildDtreeResponse(modelAndView,dtreeList);
	}
