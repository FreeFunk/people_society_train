...
public class SocietySchoolClassAndCourseService {
	...
	* */
    ...
    public List<SocietySchoolClassAndCourse> selectByAll() {
		return societySchoolClassAndCourseMapper.selectByAll();
    }

    public List<SocietySchoolClassAndCourseView> selectBySchoolIdAndCourseId(String ownerSchoolId, String courseId) {
		return societySchoolClassAndCourseMapper.selectBySchoolIdAndCourseId(ownerSchoolId,courseId);
    }
}
