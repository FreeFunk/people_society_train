...
public class SocietyTestPaperQuestion implements Serializable{
	...
	java.math.BigDecimal questionScore;
	...
	public java.math.BigDecimal getQuestionScore(){
		return this.questionScore;
	}
	
	public void setQuestionScore(java.math.BigDecimal questionScore){
    ...
    public boolean equals(Object that) {
        ...
        return  flag
        		&&(this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))		
				        		...
				        		&&(this.getQuestionAnswer() == null ? other.getId() == null : this.getQuestionAnswer().equals(other.getQuestionAnswer()))		
				;
    }
