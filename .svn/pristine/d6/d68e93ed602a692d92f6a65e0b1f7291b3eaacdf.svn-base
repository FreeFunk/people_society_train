...
public interface SocietyStudentMapper  extends BaseMapper<SocietyStudent>{
	...
	List<SocietyStudentView> selectByPhoneList(@Param("phoneNum") String phoneNum,@Param("schoolId") String schoolId);
	List<SocietyStudentView> selectByIdCardList(@Param("idCardNum")String idCardNum,@Param("schoolId") String schoolId);
...
/*同一学校手机号和身份证号不重复不能导入*/
    ...
    List<SocietyStudentView> selectBySchoolId(String schoolId);
	void updateByIdList(@Param("stuList")List<SocietyStudentView> stuList);
